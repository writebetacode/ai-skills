...
If the user's request contains a path, use it. Otherwise, search `plans/` for the most recently modified `MANIFEST.md`. If none exists, report that no multi-epic project is active and suggest `sdlc-brainstorm`.
