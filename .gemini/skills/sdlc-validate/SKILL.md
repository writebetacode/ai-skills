---
name: sdlc-validate
description: Verify an implementation plan has full requirement coverage, correct structure, and no spec drift. Use after sdlc-brainstorm to produce a plan before implementation.
---
