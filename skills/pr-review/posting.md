...
Read on entering either mode from the Workflow in `SKILL.md`. Host dispatch, the suggestion-fence and verdict tables, the finding numbering and its markers, and the Voice rules are already loaded from there and are not repeated here.
