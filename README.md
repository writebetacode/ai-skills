...
| `/sdlc-implement` | 2 -- Implement | Execute tasks with a tester-coder agent team, user review per AC, and built-in revision handling; auto-picks the next task from the manifest when called without arguments |
