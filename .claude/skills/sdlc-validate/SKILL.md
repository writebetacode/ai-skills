...
Always fix in-place, never regenerate from scratch. Never modify the spec. Show the full report even if all checks pass. ASCII only, no AI attribution. After validation, suggest clearing context and running `/sdlc-implement`.
