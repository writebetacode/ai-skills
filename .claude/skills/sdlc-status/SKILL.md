...
Print a concise dashboard showing every epic's status in a table, followed by open issue counts, then a "What's Next" section with the specific command to run. For example: "Run `/sdlc-plan plans/2026-03-28-budgeting-core-mvp/epics/2026-03-28-mock-data-layer` -- no blockers, highest priority in Phase A." If multiple epics are actionable in parallel, list them all.
